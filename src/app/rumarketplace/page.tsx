      ...
      <div className="h-4/5 bg-[url('/background/bgsky.png')] bg-cover bg-center p-2">
        ...
        <div className="grid h-80 grid-cols-1 p-1 md:grid-cols-2">
          <div className="flex grid-flow-row auto-rows-max justify-start space-x-2">
            ...
            <a href="#" className="text-3xl font-bold text-gray-600 hover:text-gray-900 md:px-10">
              ...
            </a>
          </div>
          <div className="flex grid-flow-row auto-rows-max justify-end space-x-8 pb-4">
            ...
            <div>
              <p className="text-2xl font-semibold">0,013 ETH</p>
              <p>Floor price</p>
            </div>
            <div>
              <p className="text-2xl font-semibold">0,009 WETH</p>
              <p>Best offer</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-2xl font-semibold">3 690 (85%)</p>
              <p>Owners (Unique)</p>
            </div>
          </div>
        </div>
      ...
      <div className="group relative w-full overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg">
        <div className="relative">
          <Image
            width={1000}
            height={1000}
            src="/background/bgsky.png"
            alt="RaceLad"
            className="h-96 w-full object-cover transition-transform duration-300 group-hover:scale-100"
          />

          <div className="mx-auto flex justify-end space-x-4 md:p-2 md:text-xl lg:text-2xl">
            <div className="absolute right-60 top-2 space-x-2">
              <a
                href="#"
            ...
            <div className="absolute right-20 top-2 space-x-2">
              <a
                href="#2"
                className="inline-block place-content-center rounded-xl border-2 border-p1-darkgreen bg-p1-white p-2 text-center text-base text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-p1-green hover:text-p1-white focus:border-p1-darkgreen focus:bg-p1-green focus:text-p1-white md:text-xl dark:border-p1-green dark:bg-p1-deepdarkgreen dark:text-p1-green dark:hover:border-p1-cyan dark:hover:bg-p1-deepdarkgreen dark:hover:text-p1-cyan dark:focus:border-p1-cyan dark:focus:bg-p1-deepdarkgreen dark:focus:text-p1-cyan"
              >
