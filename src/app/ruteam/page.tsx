      ...
      <div className="p-10 text-xl">
          ...
          <div className="basis-1/3 text-center text-p1-darkgreen">
            ...
            <div className="mt-3 space-y-4 text-justify text-xl leading-6 text-p1-darkgreen dark:text-slate-400">
              <p>
                ...
                ключевых членов нашей команды и помог им проявить свои уникальные таланты в рабочем
                процессе. Он сделал первые шаги, которые были действительно важны. Орагнизовал старт
                Проекта, тактику и стратегию развития компании на ближайшие 5 лет. Имеет
                международный опыт организации и проведения официальных спортивных международных
                соревнований таких как Formula-1, WTCR, национальных RDS GP, РСКГ, REC, SDC, а также
                иных автоспортивных и автокультурных мероприятий на Sochi Autodrom и Igora Drive
              </p>
            </div>
          </div>
          <div className="basis-1/3 text-center text-p1-darkgreen">
            ...
            <div className="mt-3 space-y-4 text-justify text-xl leading-6 text-p1-darkgreen dark:text-slate-400">
              <p>
                ...
                организации и проведения официальных спортивных международных соревнований таких как
                Formula-1, WTCR, национальных RDS GP, РСКГ, REC, SDC, а также иных автоспортивных и
        ...
        <div className="flex flex-row space-x-8 pb-5">
          <div className="basis-1/3 text-center text-p1-darkgreen">
            ...
            <div className="mt-3 space-y-4 text-justify text-xl leading-6 text-p1-darkgreen dark:text-slate-400">
              <p>
                ...
                Vue.js), backend (Node.js, Django), Web3 и блокчейн (Solidity, Ethereum). Руководит
                разработкой и стратегией развития автоматизации сервисов. Имеет опыт создания и
                развертывания смарт-контрактов, а также интеграцией блокчейн-сетей.
              </p>
            </div>
          </div>
          <div className="basis-1/3 text-center text-p1-darkgreen">
            ...
            <div className="mt-3 space-y-4 text-justify text-xl leading-6 text-p1-darkgreen dark:text-slate-400">
              <p>
                Лада обладает креативным подходом к выполнению задач и обширным опытом в создании и
                управлении визуальными концепциями. Специализируется на разработке бренд-стратегий,
                внедрении инновационных решений в проекты. Успешно реализовала множество проектов в
                области графического дизайна, анимации. Обеспечивает высокие стандарты креативности
                и функциональности. Обладает глубокими знаниями в области пользовательского опыта и
          ...
          <div className="basis-1/3 text-center text-p1-darkgreen">
            ...
            <div className="mt-3 space-y-4 text-justify text-xl leading-6 text-p1-darkgreen dark:text-slate-400">
              <p>
                Герман - на сегодняшний день самый молодой участник нашей команды. Он студент МГИМО.
                За плечами Германа опыт по созданию успешных социальнозначимых медиа продуктов в
                сферах Web2 и Web3. В команде Global Automotive Association Герман ответственен
                стратегию продвижения продукта и сотрудничество с отечественными и зарубежными
                партнерами.
              </p>
            </div>
          </div>
