  ...
  return (
    <div className="mx-auto flex max-w-7xl font-serif">
      ...
      <div className="p-2 text-xl md:p-2">
        ...
        <div className="rounded-3xl border-p1-darkgreen p-2 text-base text-p1-darkgreen hover:border-p1-gray hover:shadow-xl dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:my-5 md:border-4 md:p-6 md:text-xl">
          ...
          <div className="pb-5">
            ...
            по обеспечению безопасности персональных данных, предпринимаемые Децентрализованной
            автономной организацией Decentralized autonomous organization (DAO) Global Automotive
            Association (далее — Оператор).
          </div>
          <div className="pb-5">
          ...
          <div className="pb-5">
            ...
            информацию и/или документы, содержащие персональные данные;— в случае отзыва субъектом
            персональных данных согласия на обработку персональных данных, а также, направления
            обращения с требованием о прекращении обработки персональных данных, Оператор вправе
            продолжить обработку персональных данных без согласия субъекта персональных данных при
            наличии оснований, указанных в Законе о персональных данных;— самостоятельно определять
            состав и перечень мер, необходимых и достаточных для обеспечения выполнения
            обязанностей, предусмотренных Законом о персональных данных и принятыми в соответствии с
          ...
          <div className="pb-5">
            ...
            персональных данных в порядке, установленном действующим законодательством РФ;— отвечать
            на обращения и запросы субъектов персональных данных и их законных представителей в
            соответствии с требованиями Закона о персональных данных;— сообщать в уполномоченный
            орган по защите прав субъектов персональных данных по запросу этого органа необходимую
            информацию в течение 10 дней с даты получения такого запроса;— публиковать или иным
            образом обеспечивать неограниченный доступ к настоящей Политике в отношении обработки
            персональных данных;— принимать правовые, организационные и технические меры для защиты
          ...
          <div className="pb-5">
            ...
            согласия на обработку персональных данных, а также, на направление требования о
            прекращении обработки персональных данных;— обжаловать в уполномоченный орган по защите
          ...
          <div className="pb-5">
            ...
            себе;— сообщать Оператору об уточнении (обновлении, изменении) своих персональных
            данных.
          </div>
          <div className="pb-5">
          ...
          <div className="pb-5">
            Персональные данные фамилия, имя, отчество, электронный адрес, номера телефонов, год,
            месяц, дата и место рождения фотографии
          </div>
          <div className="pb-5">
            Правовые основания уставные (учредительные) документы Оператора договоры, заключаемые
            между оператором и субъектом персональных данных
          </div>
          <div className="pb-5">
            Виды обработки персональных данных Сбор, запись, систематизация, накопление, хранение,
          ...
          <div className="pb-5">
            ...
            для выполнения в полном объеме требований действующего законодательства в области защиты
            персональных данных.
          </div>
          <div className="pb-5">
          ...
          <div className="pb-5">
            ...
            электронной почты Оператора info@gaa.zone с пометкой «Актуализация персональных данных».
          </div>
          <div className="pb-5">
            ...
            электронный адрес Оператора info@gaa.zone с пометкой «Отзыв согласия на обработку
            персональных данных».
          </div>
          <div className="pb-5">
          ...
          <div className="pb-5">
            ...
            адресу http://gaa.zone/ruprivacypolicy.
          </div>
        ...
        <div className="text-center text-xl font-bold text-p1-darkgreen drop-shadow-2xl dark:text-p1-green dark:hover:text-p1-cyan md:text-4xl">
        ...
        <div className="rounded-3xl border-p1-darkgreen p-2 text-base text-p1-darkgreen hover:border-p1-gray hover:shadow-xl dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:my-5 md:border-4 md:p-6 md:text-xl">
          ...
          <div className="pb-5">
            Обязательные cookie включены по умолчанию. Их нельзя отключить, так как они используются
          ...
          <div className="pb-5">
            ...
            статистика сайта в любом случае зафиксирует переход, не используя сookie. При
            использовании такого метода может быть погрешность в результатах, но она не будет
            достигать более 10% посещений. Когда Cookie для аналитики разрешаются к использовании,
            событие досылается и посещение связывается с прошлым, чтобы статистика была точнее. Если
            во встроенной статистике включен режим упрощенной статистики, то сookie не будут
            создаваться в любом случае, даже если посетитель разрешил их использование. Google
            Analytics и Яндекс.Метрика. Пока посетитель не принял решение или отключил Cookie для
            аналитики, то код Google Analytics и Яндекс Метрики не будет передавать данных в системы
            аналитики. Код будет инициализирован только после действия пользователя. Некоторые
          ...
          <div className="pb-5">
            ...
            использования этого типа Cookie будет влиять на работу всего кода GTM. Рекламные
            системы: пиксели Facebook, ВКонтакте и другие Пока посетитель не принял решение или
            отключил Cookie для рекламных систем, код пикселей Facebook и ВКонтакте не будет
          ...
          <div className="pb-5">
            ...
            посетителем, то при переходе на другую страницу UTM-метки не будут отправлены вместе с
            данными формы. Они будут отправлены только в случае, если форма была заполнена и
