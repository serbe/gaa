    ...
    <div className="mx-auto max-w-7xl font-serif">
      <div className="flex flex-row pb-5">
        ...
        <div className="basis-3/5">
          <div className="p-2 text-center text-2xl font-bold text-p1-darkgreen drop-shadow-2xl md:text-6xl">
            Партнеры
          </div>
          <div className="text-center text-p1-darkgreen drop-shadow-2xl md:text-4xl">
