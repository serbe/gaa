...
export default function Page() {
  ...
  return (
    <div className="mx-auto max-w-7xl font-serif">
      ...
      <div className="p-2 text-center text-xl font-bold text-p1-darkgreen drop-shadow-2xl dark:text-p1-green dark:hover:text-p1-cyan md:text-4xl">
        Выгода участника
      </div>
      <div className="flex flex-wrap object-center px-2 md:flex-nowrap md:space-x-2">
        <div className="flex w-full min-w-96 flex-wrap object-center p-2 md:mb-2 md:flex-nowrap md:space-x-2">
          <div>
            ...
            <div className="my-1 rounded-3xl border-2 border-p1-darkgreen p-6 text-p1-darkgreen hover:border-p2-orange hover:shadow-xl dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:my-2 md:border-4">
