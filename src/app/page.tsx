...
export default function Page() {
  ...
  <a className ="w-2/5 bg-p1-white h-96 mb-4 relative rounded inline-block overflow-hidden rounded-3xl border-4 border-p2-orange" href="#">
  <div>
...
Генеративная коллекция
  ...
  <a className ="w-3/5 bg-p1-white h-96 mb-4 relative rounded inline-block overflow-hidden rounded-3xl border-4 border-p1-darkgreen" href="#">
  <div>
    <h2 className ="p-4 absolute bottom-0 text-p1-darkgreen liading-tight"> 
