          ...
          <div className="flex flex-row">
            <div className="mx-auto text-center md:p-8 md:text-xl lg:text-2xl">
              ...
              <div className="my-5">
                <Link
                  href="/"
                  className="inline-block rounded-xl border-2 border-p2-orange bg-p1-white px-10 py-8 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-p2-orange hover:text-p1-white"
                >
                  Создай NFT
                </Link>
              </div>
          ...
          <div className="text-centre flex flex-row">
            <div className="place-content-center p-8 text-center text-p1-darkgreen md:text-xl lg:text-2xl">
              ...
              <a
                ...
                className="inline-block place-content-center rounded-xl border-2 border-p1-green bg-p1-white px-10 py-8 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-p1-green hover:text-p1-white"
              >
                Форма заявки
              </a>
