  ...
  return (
    <div className="mx-auto flex max-w-7xl font-serif">
      ...
      <div className="p-2 text-xl md:p-2">
        ...
        <div className="my-5 rounded-3xl border-p1-darkgreen px-2 text-base text-p1-darkgreen hover:border-p2-orange hover:shadow-xl dark:hover:border-p1-green md:border-4 md:p-6 md:text-xl">
