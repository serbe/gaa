...
export default function Home() {
  ...
  const [currentVisibleArea, setCurrentVisibleArea] = useState(8);
    ...
    <div className="mx-auto w-full font-serif">
      ...
      <div className="">
        ...
        <div className="h-1/6 bg-[url('/background/bgsky.png')] bg-cover bg-center p-2 dark:brightness-75">
          ...
          {/* Слайдер коллекции 1 */}
          <div className="w-full snap-x space-x-6 place-self-center overflow-x-auto rounded-3xl bg-p1-white/0 p-4 md:-mt-10 dark:bg-p1-green/0">
            <Swiper
              autoplay={{
                delay: 9500,
        ...
        <div className="bg-opacity-60 sticky top-16 z-10 bg-p1-white shadow-md backdrop-blur-md dark:bg-p1-deepdarkgreen">
          <div className="flex justify-center space-x-2 pt-2 4xl:-translate-y-1/2 2xl:absolute 2xl:bottom-0 2xl:left-1/2 2xl:-translate-x-1/2">
            <div className="">
            ...
            <div className="flex flex-auto grid-flow-row auto-rows-max justify-center space-x-8 2xl:justify-start">
              <div>
                ...
                >
                  ...
                  <Link
                    href="#"
                    className="inline-block w-max place-content-center border bg-p1-white px-2 py-2 text-center text-p1-darkgreen shadow-lg transition-all delay-75 duration-100 ease-in-out hover:border-p1-darkgreen/15 hover:bg-p1-cyan/25 hover:text-p1-darkgreen focus:border-p1-darkgreen/20 focus:bg-p1-cyan focus:text-p1-white md:text-xl lg:px-2 xl:px-3 2xl:px-4 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:text-p1-green dark:hover:border-p1-cyan dark:hover:bg-p1-deepdarkgreen dark:hover:text-p1-cyan dark:focus:border-p1-cyan dark:focus:bg-p1-deepdarkgreen dark:focus:text-p1-cyan"
                  >
                    Предложения
                  </Link>
                  <button
                  ...
                  <form className="hidden w-max  place-content-center rounded-r-xl border bg-p1-white px-2 py-2 text-center text-p1-darkgreen shadow-lg transition-all delay-75 duration-100 ease-in-out hover:border-p1-darkgreen/15 hover:bg-p1-cyan/25 hover:text-p1-darkgreen focus:border-p1-darkgreen/20 focus:bg-p1-cyan focus:text-p1-white md:text-xl lg:px-2 xl:block xl:px-3 2xl:px-4 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:text-p1-green dark:hover:border-p1-cyan dark:hover:bg-p1-deepdarkgreen dark:hover:text-p1-cyan dark:focus:border-p1-cyan dark:focus:bg-p1-deepdarkgreen dark:focus:text-p1-cyan">
                    ...
                    <select
                      id="price"
                      className="hover:border-opacity-15 mx-auto flex overflow-hidden rounded-r-xl bg-p1-white hover:bg-p1-green/25 hover:text-p1-darkgreen dark:bg-p1-deepdarkgreen dark:text-p1-green dark:accent-p1-darkgreen dark:hover:bg-p1-deepdarkgreen dark:hover:text-p1-cyan"
        ...
        <div className="flex max-w-full place-content-center gap-2 px-6">
          ...
          <div className="relative flex min-h-screen w-full max-w-full grid-flow-row flex-wrap justify-center gap-2 overflow-hidden pt-2">
            ...
            <div id="area2" className={` ${currentVisibleArea == 2 ? '' : 'hidden'}`}>
            ...
            <div id="area3" className={`${currentVisibleArea == 3 ? '' : 'hidden'}`}>
              <div className="flex gap-4">
                <div className="group relative h-[14.5rem] w-40 place-self-center overflow-hidden rounded-xl bg-white object-cover shadow-lg transition-transform duration-300 group-hover:shadow-xs hover:shadow-lg hover:shadow-p1-cyan dark:bg-p1-deepdarkgreen dark:shadow-p1-darkgreen dark:hover:shadow-p1-darkgreen">
                  <div>
            ...
            <div id="area5" className={`${currentVisibleArea == 5 ? '' : 'hidden'}`}>
              <div className="flex gap-4">
                <div className="group relative h-[28rem] w-80 place-self-center overflow-hidden rounded-xl bg-white object-cover shadow-lg transition-transform duration-300 group-hover:shadow-xs hover:shadow-lg hover:shadow-p1-cyan dark:bg-p1-deepdarkgreen dark:shadow-p1-darkgreen dark:hover:shadow-p1-darkgreen">
                  <div>
                    <div className="group invisible absolute top-1 right-1 z-10 inline-block duration-300 ease-in-out group-hover:visible group-hover:opacity-100">
                      <Link
                        href="#"
            ...
            <div id="area6" className={`${currentVisibleArea == 6 ? '' : 'hidden'}`}>
              <div className="flex gap-4">
                <div className="group relative h-[39rem] w-[28rem] place-self-center overflow-hidden rounded-xl bg-white object-cover shadow-lg transition-transform duration-300 group-hover:shadow-xs hover:shadow-lg hover:shadow-p1-cyan dark:bg-p1-deepdarkgreen dark:shadow-p1-darkgreen dark:hover:shadow-p1-darkgreen">
                  <div>
                    <div className="group invisible absolute top-1 right-1 z-10 inline-block duration-300 ease-in-out group-hover:visible group-hover:opacity-100">
                      <Link
                        href="#"
            ...
            <div id="area8" className={`${currentVisibleArea == 8 ? '' : 'hidden'}`}>
              <div className="flex gap-4">
                <div className="group relative w-80 place-self-center overflow-hidden rounded-xl bg-white object-cover shadow-lg transition-transform duration-300 group-hover:shadow-xs hover:shadow-lg hover:shadow-p1-cyan dark:bg-p1-deepdarkgreen dark:shadow-p1-darkgreen dark:hover:shadow-p1-darkgreen">
                  <div>
                    <div className="group invisible absolute top-1 right-1 z-10 inline-block duration-300 ease-in-out group-hover:visible group-hover:opacity-100">
                      <Link
                        href="#"
              ...
              <div>
                <div className="grid h-1/5 grid-cols-1 place-content-center p-1 text-sm sm:px-2 md:px-4 lg:grid-cols-2 lg:px-6 lg:text-base xl:px-2 xl:text-lg 2xl:px-10 2xl:text-xl">
                  <div className="flex grid-flow-row auto-rows-max place-content-center space-x-2 lg:justify-start">
                    <div>
                      <div
                        className="inline-flex w-full justify-center rounded-md shadow-xs"
                        role="group"
                      >
                        <Link
                          href="#"
                  ...
                  <div className="flex flex-auto grid-flow-row auto-rows-max justify-center space-x-8 lg:justify-end">
                    <div className="">
                      <div
                        className="inline-flex w-full flex-auto justify-center rounded-md shadow-xs"
                        role="group"
                      >
                        <Link
                          href="#"
            ...
            <div id="area9" className={` ${currentVisibleArea == 9 ? '' : 'hidden'}`}>
              <div className="columns-1 gap-24 xl:columns-2 dark:border-p1-green">
                <div className="relative sm:rounded-lg">
                  <table className="text-left text-xl text-p1-darkgreen dark:text-p1-green">
                    <thead className=" sticky top-0 border-b-2 border-p1-green/20 bg-p1-white text-xs text-p1-darkgreen uppercase dark:bg-p1-deepdarkgreen dark:text-p1-green">
                      <tr>
                        <th scope="col" className="p-2">
                          Rank
                        </th>
                ...
                <div className="relative sm:rounded-lg">
                  <table className="text-left text-xl text-p1-darkgreen dark:text-p1-green">
                    ...
                    <tbody>
                      <tr className="border-b-2 bg-p1-white hover:bg-p1-cyan/5 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:hover:text-p1-cyan">
                        <td className="px-4 py-2 lining-nums">6</td>
                        <td className="p-2">
                          <div className="relative">
                            <Link href="/card" className="mx-auto justify-center">
                              <Image
                      ...
                      <tr className="border-b-2 bg-p1-white hover:bg-p1-cyan/5 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:hover:text-p1-cyan">
                        <td className="px-4 py-2 lining-nums">7</td>
                        <td className="p-2">
                          <div className="relative">
                            <Link href="/card" className="mx-auto justify-center">
                              <Image
                      ...
                      <tr className="border-b-2 bg-p1-white hover:bg-p1-cyan/5 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:hover:text-p1-cyan">
                        <td className="px-4 py-2 lining-nums">8</td>
                        <td className="p-2">
                          <div className="relative">
                            <Link href="/card" className="mx-auto justify-center">
                              <Image
                      ...
                      <tr className="border-b-2 bg-p1-white hover:bg-p1-cyan/5 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:hover:text-p1-cyan">
                        <td className="px-4 py-2 lining-nums">9</td>
                        <td className="p-2">
                          <div className="relative">
                            <Link href="/card" className="mx-auto justify-center">
                              <Image
                      ...
                      <tr className="border-b-2 bg-p1-white hover:bg-p1-cyan/5 dark:border-p1-green dark:bg-p1-deepdarkgreen dark:hover:text-p1-cyan">
                        <td className="px-4 py-2 lining-nums">10</td>
                        <td className="p-2">
                          <div className="relative">
                            <Link href="/card" className="mx-auto justify-center">
                              <Image
