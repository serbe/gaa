  ...
  return (
    <div className="mx-auto flex max-w-7xl font-serif">
      ...
      <div className="p-2 text-xl md:p-2">
        ...
        <div className="border-p1-darkgreen text-p1-darkgreen hover:border-p2-orange dark:hover:border-p1-green my-5 rounded-3xl px-2 text-base hover:shadow-xl md:border-4 md:p-6 md:text-xl">
