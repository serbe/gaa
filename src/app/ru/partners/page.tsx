    ...
    <div className="mx-auto max-w-7xl font-serif">
            ...
            <div className="mx-auto text-center md:p-2 md:text-xl lg:text-2xl">
              ...
              <div className="flex flex-row justify-center">
                <div className="basis-1/5">
                  <Image width={200} height={500} src="/Hero/h77.png" alt="Hero77" />
                </div>
                ...
                <div className="basis-1/5">
                  <Image width={200} height={600} src="/Hero/h5.png" alt="Hero5" />
                </div>
              </div>
              <div className="my-5">
                <Link
      ...
      <div className="flex flex-row justify-center md:pb-5">
        <div className="basis-1/6 p-2">
          <Image width={200} height={500} src="/Hero/h9.png" alt="Hero9" />
        </div>
      </div>
      ...
      <div className="flex flex-row justify-center md:pb-5">
        <div className="basis-1/6 p-2">
          <Image width={200} height={600} src="/Hero/h3.png" alt="Hero5" />
        </div>
      </div>
      <div className="md:pb-96"></div>
      <div className="md:pb-48"></div>
