export default function Page() {
  return (
    <div>
      <div className="pb-5 text-center font-bold text-6xl">RaceLads</div>
      ...
      <div className="pb-5 text-center font-bold text-4xl">RaceLads NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      {/* //Лидеры движений */}
      <div className="pb-5 text-center font-bold text-6xl">Лидеры движений</div>
      <div className="pb-5 text-center font-bold text-6xl">
        знаковые персоны
      </div>
      {/* //Drivers */}
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
      ...
      <div className="pb-5 text-center font-bold text-4xl">Drivers NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      <div className="pb-5 text-center font-bold text-4xl">Team's Members</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      <div className="pb-5 text-center font-bold text-4xl">Collectors NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      <div className="pb-5 text-center font-bold text-4xl">Cars NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      // CustomLads
      <div className="pb-5 text-center font-bold text-6xl">CustomLads</div>
      <div className="pb-5 text-center font-bold text-4xl">
        by Global Automotive Association
      </div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
      ...
      <div className="pb-5 text-center font-bold text-4xl">CustomLad NFT</div>
      <div className="pb-5 text-center font-bold text-4xl">
        Страница создания NFT
      </div>
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
      ...
      //Награды
      <div className="pb-5 text-center font-bold text-6xl">Награды</div>
      <div className="pb-5 text-center font-bold text-4xl">Кубки и медали</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
      ...
      <div className="pb-5 text-center font-bold text-4xl">NFT Награды</div>
      <div className="pb-5 text-center font-bold text-4xl">
        Страница создания NFT
      </div>
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
      ...
      //Лицензии
      <div className="pb-5 text-center font-bold text-6xl">Лицензии</div>
      <div className="pb-5 text-center font-bold text-6xl">
      ...
      <div className="pb-5 text-center font-bold text-4xl">Global License</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center ">
