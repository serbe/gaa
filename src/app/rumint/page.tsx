...
export default function Page() {
  ...
  return !gaaStore.persist?.hasHydrated() ? (
    ...
    <div className="mx-auto max-w-7xl font-serif">
      ...
      <div
        id="racelads"
        className="text-center text-4xl font-bold text-p1-darkgreen dark:text-p1-green dark:hover:text-p1-cyan md:pt-4 md:text-6xl"
      >
        RaceLads
      ...
      <div className="w-full place-self-center rounded-3xl border-p1-darkgreen text-center text-p1-darkgreen dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:w-3/5 md:border-4 md:shadow-lg">
        <div>
          ...
          <Image
            className="relative mb-2 inline-block w-2/5 rounded-3xl border-2 border-p2-orange shadow-lg dark:border-p1-green md:w-2/5"
            width={1000}
            height={1000}
      ...
      <div
        id="movement-leaders"
        className="p-2 text-center text-4xl font-bold text-p1-darkgreen dark:text-p1-green dark:hover:text-p1-cyan md:pt-20 md:text-6xl"
      >
        Лидеры движений
        <p className="pb-2 text-center text-xl md:pb-5 md:text-4xl">знаковые персоны</p>
      </div>
      <div className="mx-5 grid grid-cols-1 gap-2 rounded-3xl border-p1-darkgreen text-center text-p1-darkgreen dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:grid-cols-2 md:border-4 md:p-5 md:shadow-lg xl:grid-cols-4">
        <div>
          <p className="text-2xl">Drivers</p>
          <Image
            className="relative mb-4 inline-block w-3/5 rounded-3xl border-2 border-red-400 shadow-lg dark:border-p1-green md:w-full"
            width={1000}
            height={1000}
          ...
          <div className="py-5">
            ...
            <Link
              href={'/rumintdrivers'}
              className="rounded-r-xl border-2 border-red-400 bg-p2-white2 p-2 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-red-400 hover:text-p1-white focus:z-10 focus:bg-red-400 focus:text-p1-white focus:ring-2 focus:ring-red-400 dark:border-p1-green dark:bg-p1-darkgreen dark:text-p1-cyan dark:hover:bg-red-400 dark:hover:text-red-100 dark:focus:text-p1-cyan dark:focus:ring-p1-green md:p-5"
            >
              Создай NFT
            </Link>
          </div>
        ...
        <div>
          ...
          <Image
            className="relative mb-4 inline-block w-3/5 rounded-3xl border-2 border-p3-blue shadow-lg dark:border-p1-green md:w-full"
            width={1000}
            height={1000}
          ...
          <div className="py-5">
            ...
            <Link
              ...
              className="rounded-r-xl border-2 border-p3-blue bg-p2-white2 p-2 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-p3-blue hover:text-p1-white focus:z-10 focus:bg-p3-blue focus:text-p1-white focus:ring-2 focus:ring-p3-blue dark:border-p1-green dark:bg-p1-darkgreen dark:text-p1-cyan dark:hover:bg-p3-blue dark:hover:text-white dark:focus:text-white dark:focus:ring-p3-blue md:p-5"
            >
              Cоздай NFT
            </Link>
          </div>
        ...
        <div>
          ...
          <Image
            className="relative mb-4 inline-block w-3/5 rounded-3xl border-2 border-stone-500 shadow-lg dark:border-p1-green md:w-full"
            width={1000}
            height={1000}
          ...
          <div className="py-5">
            ...
            <Link
              ...
              className="rounded-r-xl border-2 border-stone-500 bg-p2-white2 p-2 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-stone-500 hover:text-p1-white focus:z-10 focus:bg-stone-500 focus:text-p1-white focus:ring-2 focus:ring-stone-500 dark:border-p1-green dark:bg-p1-darkgreen dark:text-p1-cyan dark:hover:bg-stone-500 dark:hover:text-stone-100 dark:focus:text-white dark:focus:ring-stone-500 md:p-5"
            >
              Cоздай NFT
            </Link>
          </div>
        ...
        <div>
          ...
          <div className="py-5">
            ...
            <Link
              href={'/rumintcars'}
              className="rounded-r-xl border-2 border-cyan-700 bg-p2-white2 p-2 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-cyan-700 hover:text-p1-white focus:z-10 focus:bg-cyan-700 focus:text-p1-white focus:ring-2 focus:ring-cyan-700 dark:border-p1-green dark:bg-p1-darkgreen dark:text-p1-cyan dark:hover:bg-cyan-700 dark:hover:text-white dark:focus:text-white dark:focus:ring-cyan-700 md:p-5"
            >
              Cоздай NFT
            </Link>
          </div>
      ...
      <div
        id="awards"
        className="pt-2 text-center text-4xl font-bold text-p1-darkgreen dark:text-p1-green dark:hover:text-p1-cyan md:pt-20 md:text-6xl"
      >
        Награды
      ...
      <div className="m-5 grid grid-cols-1 gap-2 place-self-center rounded-3xl border-p1-darkgreen p-5 text-center text-p1-darkgreen dark:text-p1-green dark:hover:border-p1-green dark:hover:text-p1-cyan md:grid-cols-3 md:border-4 md:shadow-lg">
        <div className="mb-4 mt-4">
          ...
          <Link
            href={'/rulicense'}
            onClick={() => setLicense(0)}
            className="rounded-r-xl border-2 border-amber-600 bg-p2-white2 p-2 text-p1-darkgreen shadow-lg transition-all delay-75 duration-300 ease-in-out hover:bg-amber-600 hover:text-p1-white focus:z-10 focus:bg-amber-600 focus:text-p1-white focus:ring-2 focus:ring-amber-600 dark:border-p1-green dark:bg-p1-darkgreen dark:text-p1-cyan dark:hover:border-amber-600 dark:hover:bg-amber-800 dark:hover:text-white dark:focus:text-white dark:focus:ring-amber-600 md:p-5"
          >
            Cоздай NFT
          </Link>
        </div>
