    ...
    <div>
      ...
      <div className="m-5 flex rounded-3xl border-4 border-p1-darkgreen">
        <div className="flex items-start">
          <a className="w-5/8 relative mb-4 inline-block overflow-hidden rounded-3xl">
            <div>
              <div className="flex flex-row">
                <div className="place-content-center p-8 text-left">
                  <p className="p-2 text-xl text-p1-darkgreen">
                    ...
                    уникальных цифровых героев, вдохновленных любовью к
                    автомобилям и запечатленных в Blockchain.
                  </p>
                  <p className="p-2 text-xl text-p1-darkgreen">
                    Кто твой персонаж - решать тебе!
                  </p>
                  ...
                  <ul className="list-disc space-y-5 px-5 text-xl text-p1-darkgreen">
                    ...
                    <li>
                      участвуй в виртуальных гонках и других захватывающих
                      онлайн событиях
                    </li>
                    <li>
                  ...
                  <p className="p-2 text-xl text-p1-darkgreen">
                    NFT коллекция RaceLads даст новый виток развития
                    автокультурного сообщества и интеграции с Web3 и Blockchain.
                  </p>
                </div>
              </div>
            </div>
          ...
          <a className="w-1/8 relative mb-1 inline-block overflow-hidden rounded-3xl">
            <div>
              <div className="flex flex-row">
          ...
          <a className="w-1/8 relative inline-block overflow-hidden rounded-3xl">
            <div>
              <div className="flex flex-row">
                <div className="place-content-center space-y-2 p-2 text-center">
                  <Image
              ...
              <div className="p-5">
                {" "}
                <button className="rounded-lg border-2 border-p1-darkgreen bg-p1-white px-10 py-8 text-p1-darkgreen shadow-lg hover:bg-p2-orange hover:text-p1-white">
                  Страница создания NFT
                </button>
              </div>
            </div>
      ...
      <div className="my-5 rounded-3xl border-4 border-p1-darkgreen p-6">
        ...
        <Image className="relative inline-block w-max overflow-hidden rounded rounded-3xl"
            width={1000}
            height={1000}
      ...
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        ...
        <div className="pb-5 text-center">
          Первая коллекция GAA из 10,000 уникальных героев RaceLads
        </div>
        <div className="pb-5 text-center">
          Максимальное количество: 10 RaceLads за транзакцию
        </div>
        <div className="pb-5 text-center font-bold">Создай NFT </div>
      ...
      <div className="pt-5 text-center text-6xl font-bold text-p1-darkgreen">Лидеры движений
      </div>
      <div className="pb-5 text-center text-4xl font-bold text-p1-darkgreen">
      знаковые персоны
      </div>
<div className="з-5 m-5 rounded-3xl border-4 border-p1-darkgreen" >
<div class="flex grid grid-cols-8 gap-4">
  <div class="col-span-2 col-start-1 w-full rounded-3xl border-4 p-2 text-center text-p1-darkgreen">
  <Image className="relative mb-4 inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
            ...
            alt="RaceLads1"
          />
            <button className="rounded-l-xl border-2 border-p1-darkgreen bg-p1-white p-2 text-xs text-p1-darkgreen shadow-lg hover:bg-p1-darkgreen hover:text-p1-white">
        Исследуй NFT
          </button>
          <button className="rounded-r-xl border-2 border-p1-darkgreen bg-p1-white p-2 text-xs text-p1-darkgreen shadow-lg hover:bg-p2-orange hover:text-p1-white">
        Cоздание NFT
          </button>
    </div>

    <div class="col-span-2 col-start-3 w-full rounded-3xl p-2 text-center text-p1-darkgreen shadow-lg">
    <Image className="relative mb-4 inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
            width={1000}
            height={1000}
            src="/HeroNFT/RaceLads/RaceLads1.png"
...
<div class="col-span-2 col-start-5 w-full rounded-3xl p-2 text-center text-p1-darkgreen shadow-lg">
<Image className="relative mb-4 inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
            width={1000}
            height={1000}
            src="/HeroNFT/RaceLads/RaceLads1.png"
...
<div class="col-span-2 col-start-7 w-full rounded-3xl p-2 text-center text-p1-darkgreen shadow-lg">
<Image className="relative mb-4 inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
            width={1000}
            height={1000}
            src="/HeroNFT/RaceLads/RaceLads1.png"
...
<p className="p-2 text-xl text-p1-darkgreen">
 ...
 <ul className="list-disc space-y-5 px-5 text-xl text-p1-darkgreen">
  ...
  NFT коллекция RaceLads даст новый виток развития автокультурного сообщества и интеграции с Web3 и Blockchain.
        ...
        <Image className="relative inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
          ...
          />
              ...
              <div class="p-5">   <button className="rounded-3xl border-2 border-p1-darkgreen bg-p1-white px-10 py-8 text-p1-darkgreen shadow-lg hover:bg-p2-orange hover:text-p1-white">
        Страница создания NFT
          </button>
</div>
              <div className="p-5">
      ...
      <div class="flex grid grid-cols-6 gap-4">
        <div className="start col-span-3 col-start-1 w-full text-2xl text-4xl font-bold text-p2-orange"> RaceLads NFT
        </div>
        <div className="start col-span-3 col-end-7 w-full text-end text-2xl text-4xl font-bold text-p2-orange"> Страница создания NFT
      <div className="pb-5 text-center text-4xl font-bold">RaceLads NFT</div>
      <div className="pb-5 text-center text-4xl font-bold">
        Страница создания NFT
      </div>
  ...
  <div class="col-span-4 col-start-2 w-full rounded-3xl border-4 border-p2-orange text-center text-p1-darkgreen shadow-lg">
  
  <div>
  <p className="p-2 text-2xl text-p1-darkgreen">
Присоединяйтесь к нам!              </p>
              <h2 className="pb-2 text-2xl text-p1-darkgreen">
               Получи своего геороя RaceLad
              </h2>
              <Image className="relative mb-4 inline-block w-max overflow-hidden rounded rounded-3xl border-2 border-p2-orange shadow-lg"
            width={1000}
            height={1000}
            ...
            alt="RaceLads1"
          />
            <p className="pt-2 text-xl text-p1-darkgreen">
            Первая коллекция GAA из 10,000 уникальных героев RaceLads                </p>
              <p className="pb-2 text-xl text-p1-darkgreen">
              Максимальное количество: 10 RaceLads за транзакцию
             </p>
             <p className="pb-2 text-xl text-p2-red">
              надо добавить полоску выбора количества NFT и рсчет цены за минта
             </p>
         
          <button className="rounded-3xl border-2 border-p1-darkgreen bg-p1-white px-40 py-8 text-p1-darkgreen shadow-lg hover:bg-p2-orange hover:text-p1-white">
        Создай NFT
          </button>
          <div className="pb-8"></div>
      </div>
...
///////////////////
      ...
      <div className="pb-5 text-center text-6xl font-bold">Лидеры движений</div>
      <div className="pb-5 text-center text-6xl font-bold">
        знаковые персоны
      </div>
      {/* //Drivers */}
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">Drivers</div>
        <div className="pb-5 text-center">
      ...
      <div className="pb-5 text-center text-4xl font-bold">Drivers NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
      ...
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        <div className="text-center font-bold">Присоединяйтесь к нам</div>
        <div className="pb-5 text-center font-bold">Создай NFT Пилота</div>
        <div className="pb-5 text-center">
        ...
        <div className="pb-5 text-center">Фото Пилота</div>
        <div className="pb-5 text-center">
          Заполни метаданные Пилота во все поля
        </div>
        <div className="pb-5 text-center">Дисциплина</div>
        <div className="pb-5 text-center">Название команды</div>
        <div className="pb-5 text-center">ФИО</div>
        ...
        <div className="pb-5 text-center">Количество NFT</div>
      ...
      {/* //Team's Members */}
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">Team&apos;s Members</div>
        <div className="pb-5 text-center">
      ...
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        ...
        <div className="pb-5">
          ...
          автоспорта, поэтому мы бы хотели запечатлеть каждого из них в единой
          коллекции.
        </div>
        <div className="pb-5">
          Предполагается, что первоначальным владельцем NFT будет сам член
          команды. Позже по желанию владельца токен может быть передан/продан
          любому человеку.
        </div>
      </div>
      <div className="pb-5 text-center text-4xl font-bold">
      ...
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
          Верификацию статуса члена команды можно запросить у любого из лиц,
          владеющих хотя бы одной из NFT лицензий: Management, National License,
          Promoter License
        </div>
        <div className="pb-5 text-center">
          Только верифицированные пользователи смогут получить NFT из коллекции
      ...
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        ...
        <div className="pb-5 text-center">Фото участника команды</div>
        <div className="pb-5 text-center">
          Заполни метаданные участника команды во все поля
        </div>
        <div className="pb-5 text-center">Дисциплина</div>
        <div className="pb-5 text-center">Название команды</div>
        <div className="pb-5 text-center">ФИО</div>
      ...
      {/* //Collectors */}
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">Collectors</div>
        <div className="pb-5 text-center">
      ...
      <div className="pb-5 text-center text-4xl font-bold">Collectors NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
        ...
        <div className="pb-5">
          ...
          автоспорта и хотели бы запечатлеть историю каждого в единой коллекции.
        </div>
        <div className="pb-5">
      ...
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
          Верификацию статус коллекционера можно запросить у любого из лиц,
          владеющих хотя бы одной из NFT лицензий: Management, National License,
          Promoter License
        </div>
        <div className="pb-5 text-center">
      ...
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        ...
        <div className="pb-5 text-center">Фото Коллекционера</div>
        <div className="pb-5 text-center">
          Заполни метаданные Коллекционера во все поля
        </div>
        <div className="pb-5 text-center">Страна</div>
        <div className="pb-5 text-center">Город</div>
        <div className="pb-5 text-center">ФИО</div>
      ...
      \\Cars
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">Cars</div>
        <div className="pb-5 text-center">
      ...
      <div className="pb-5 text-center text-4xl font-bold">Cars NFT</div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
        ...
        <div className="pb-5 text-center">
          Каждый NFT содержит метаданные, хранящие информацию о коллекционном
          экземпляре, его описание и характеристики.
        </div>
        <div className="pb-5">
      ...
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
          Только владельцы следующих NFT коллекций смогут оцифровать свои
          автомобили: Drivers, Team&apos;s members, Collectors
        </div>
      </div>
      <div className="pb-5 text-center text-4xl font-bold">
        Rarity / Sport Car NFT
      </div>
      <div className="pb-5 text-center text-4xl font-bold">
        Страница создания NFT
      </div>
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        ...
        <div className="pb-5 text-center">
          Создайте NFT своего раритетного/спортивного автомобиля
        </div>
        <div className="pb-5 text-center">
          Добавьте фото раритетного/спортивнога автомобиля
        </div>
        <div className="pb-5 text-center">
          Если вы планируете раздать или продать свои NFT, вы можете сделать
          несколько NFT одновременно
        </div>
        <div className="pb-5 text-center">Фото автомобиля</div>
        <div className="pb-5 text-center">
          Заполни метаданные автомобиля во все поля
        </div>
        <div className="pb-5 text-center">
          Категория Rarity / Sport / Drift / TCR / Oldtimer / Stance etc
        </div>
        <div className="pb-5 text-center">Самодельный или оригинальный</div>
        <div className="pb-5 text-center">
          ФИО - Создатель/Владелец автомобиля
        </div>
        <div className="pb-5 text-center">Ник Имя</div>
        <div className="pb-5 text-center">Дата рождения</div>
        <div className="pb-5 text-center">Марка автомобилям</div>
        <div className="pb-5 text-center">Модель автомобилям</div>
        <div className="pb-5 text-center">Год создания</div>
        <div className="pb-5 text-center">Двигатель</div>
        <div className="pb-5 text-center">Лошадиных сил</div>
        <div className="pb-5 text-center">Страна</div>
        <div className="pb-5 text-center">Город</div>
        <div className="pb-5 text-center">Описание</div>
        <div className="pb-5 text-center">
      ...
      {/* // CustomLads */}
      <div className="pb-5 text-center text-6xl font-bold">CustomLads</div>
      <div className="pb-5 text-center text-4xl font-bold">
        by Global Automotive Association
      </div>
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        ...
        <div className="pb-5 text-center">
          Владельцы NFT из коллекции RaceLads смогут создать своего героя
        </div>
        <div className="pb-5 text-center">Исследовать </div>
        <div className="pb-5 text-center">Страница создания NFT</div>
      </div>
      ...
      <div className="my-5 rounded-3xl border-4 border-gray-500 p-6">
        <div className="pb-5 text-center">
          Невзаимозаменяемый токен, представляющий кастомизированного героя из
          элементов первой генеративной коллекции RaceLads, который собран его
          владельцем.
        </div>
        <div className="pb-5 text-center">Кто твой персонаж - решать тебе!</div>
        <div className="pb-5">
          Мы очень ценим вклад каждого неравнодушного к проекту и готовы
          предоставить возможность формирования героя по своим предпочтениям.
        </div>
        <div className="pb-5">
          Мы стали свидетелями дублирования (воровства) существующих коллекций и
          выступаем против подобных деяний, поэтому хотим дать каждому
          возможность собрать своего героя легальным способом.
        </div>
        <div className="pb-5">
          Данная коллекция будет доступна только начала минта героев коллекции
          RaceLads.
        </div>
        <div className="pb-5">
          Процесс создания героя в коллекции CustomLads предусматривает создание
          уникального NFT, то есть создать дубликат героя из коллекции RaceLads
          и CustomLads будет нельзя!
        </div>
        <div className="pb-5">
          Любой CustomLad по желанию держателя может быть передан/продан любому
          участнику сообщества.
        </div>
        <div className="pb-5">
          Так мы планируем поддержать, отблагодарить всех держателей коллекции
          RaceLads и предоставить им возможность дополнительных инвестиций
        </div>
      </div>
      <div className="pb-5 text-center text-4xl font-bold">
      ...
      <div className="pb-5 text-center text-4xl font-bold">CustomLad NFT</div>
      <div className="pb-5 text-center text-4xl font-bold">
        Страница создания NFT
      </div>
      <div className="my-5 rounded-3xl border-4 border-orange-400 p-6">
        <div className="text-center font-bold">Присоединяйтесь к нам</div>
        <div className="pb-5 text-center font-bold">
          Создай своего героя CustomLad
        </div>
        <div className="pb-5 text-center">
          Собери своего героя в коллекции GAA
        </div>
        <div className="pb-5 text-center">более 1,000 уникальных элементов</div>
        <div className="pb-5 text-center">добавить слайдеры для элементов</div>
        <div className="pb-5 text-center">
          Максимальное количество: 1 CustomLad за транзакцию
        </div>
        <div className="pb-5 text-center font-bold">Создай NFT </div>
        <div className="pb-5 text-center font-bold"></div>
      </div>
