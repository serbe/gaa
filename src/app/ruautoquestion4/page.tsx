    ...
    <div className="mx-auto max-w-7xl font-serif">
      ...
      <div>
        ...
        <p className="pb-5 font-semibold">
          ...
          популяризатором дрифта считается Кейити Цучия (Keiichi Tsuchiya), известный как "Король
          дрифта". Он был профессиональным автогонщиком и первым стал использовать технику
          скольжения на горных дорогах Японии. Профессиональные соревнования по дрифту впервые были
          организованы в Японии в 1980-х годах. В 2000 году появилась первая официальная дрифт-серия
          — D1 Grand Prix, что сделало дрифт полноценной дисциплиной автоспорта. С тех пор дрифт
          приобрел мировую популярность и стал неотъемлемой частью культуры автоспорта.
        </p>
        <p className="pb-5">
        ...
        <p className="pb-5">
          ...
          водителей принял дрифт как вид автоспорта и вскоре стал его "лицом" в США. Окончательное
          формирование дрифт-культуры в США связано с организацией Formula Drift (Formula D) —
          первой профессиональной дрифт-серии в Северной Америке, запущенной в 2004 году. Formula
          Drift была создана для развития и продвижения дрифта как автоспортивной дисциплины в США и
          быстро получила широкое признание.
        </p>
