  ...
  return (
    <div className="mx-auto max-w-7xl font-serif">
      <div className="flex flex-wrap justify-between space-x-2 object-center px-2 pt-5 md:flex-nowrap">
        <div className="p-2 text-center text-4xl font-semibold text-red-400">Drivers NFT</div>
        <div className="p-2 text-center text-4xl font-semibold text-red-400">
          Страница создания NFT
        </div>
      </div>
      <section className="mb-2 flex w-full min-w-96 flex-wrap space-x-2 rounded-3xl border-4 border-red-400 bg-p1-white object-center p-2 shadow-lg md:flex-nowrap">
