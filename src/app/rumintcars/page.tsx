        ...
        <div className="grid grid-cols-1 md:w-max md:grid-cols-2 md:gap-4">
          <div className="p-2">
            <div className="text-center md:text-2xl lg:text-2xl">
              <div className="">
                <div className="flex flex-wrap px-2 pt-2 md:fixed md:w-1/4 md:flex-nowrap">
                  <div className="">
                    ...
                    <div className="grid-1 grid flex-wrap-reverse gap-2 md:w-full md:grid-cols-3">
                      <div className="place-items-center p-2">
                        <Image
                          ...
                          alt="Car"
                        />
                        <button className="w-full rounded-3xl border-2 border-p1-darkgreen bg-p2-white2 p-8 text-center text-base font-normal text-p1-darkgreen shadow-lg hover:bg-cyan-700 hover:text-p1-white md:text-xl">
          ...
          <div>
            <div className="flex flex-col object-right p-2 md:w-full">
              ...
              <button className="rounded-3xl border-2 border-p1-darkgreen bg-p2-white2 px-20 py-8 text-p1-darkgreen shadow-lg hover:bg-cyan-700 hover:text-p1-white">
