  ...
  return (
    <div className="mx-auto max-w-7xl font-serif">
      <div className="flex flex-wrap justify-center md:flex-nowrap md:justify-between">
        <div className="px-2 text-2xl font-semibold text-p3-blue md:pt-2 md:text-4xl">
          Team&apos;s members NFT
        </div>
        <div className="px-2 text-2xl font-semibold text-p3-blue md:pt-2 md:text-4xl">
      ...
      <section className="flex flex-wrap rounded-3xl border-p3-blue bg-p1-white p-2 md:flex-nowrap md:border-4 md:shadow-lg">
              ...
              <div className="">
                <div className="flex flex-wrap px-2 pt-2 md:flex-nowrap">
                  <div className="">
                    ...
                    <div className="z-10 rounded-3xl border-2 bg-p3-blue py-5 md:sticky md:top-16">
