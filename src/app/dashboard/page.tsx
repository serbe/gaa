        ...
        >
          <div className="text-centre flex flex-row">
            <div className="place-content-center p-2 text-center text-p1-darkgreen md:text-xl lg:text-2xl dark:text-p1-cyan">
              ...
              <div className="mt-2 rounded-3xl bg-p2-white2 p-2 text-p1-darkgreen">
                <div className="px-2 text-xl font-semibold text-p1-darkgreen md:pt-2 md:text-3xl">
                  ...
                  <div className="mt-2 grid grid-cols-7 gap-2 space-x-2 p-4 text-base md:text-xl">
                    <a
                      href="#"
                      className="block max-w-sm rounded-3xl border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                    >
                      <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        RaceLads{' '}
                      </h5>
                      <p className="font-normal text-gray-700 dark:text-gray-400">10000 RaceLads</p>
                    </a>
                    ...
                    >
                      ...
                      <p className="font-normal text-gray-700 dark:text-gray-400">5000 Drivers</p>
                    </a>
                    <a
                      href="#"
                      className="block max-w-sm rounded-3xl border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                    ...
                    >
                      ...
                      <p className="font-normal text-gray-700 dark:text-gray-400">15000 Лицензий</p>
                    </a>
                  </div>
                </div>
              </div>
